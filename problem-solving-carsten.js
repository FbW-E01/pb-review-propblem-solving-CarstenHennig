...
// 0. *NOTE* Before you start to actually work (code) on each question, make work estimates for each one;
// how long it will take you to solve each question.
...
// 2. Explain each line of code here (answer as a series of comments)
        ...
        function getSome(...arguments) { // function with multiple variables
            const args = arguments.slice(1, 3); // all given variables will be copied from index no 1 until index no 3
            return args; // copied variables stored in new variable returned
        }
        console.log(getSome(90, 100, 75, 40, 89, 95)); // calling function with numerous variables
